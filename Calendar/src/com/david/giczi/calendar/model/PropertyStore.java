...
public class PropertyStore {
	...
	public static void loadPropertiesFromFile() {
		...
		try(BufferedReader reader = new BufferedReader
		   ...
		   PropertyStore.URL1 = properties.getProperty("url1");
		   PropertyStore.URL2 = properties.getProperty("url2");
		   PropertyStore.URL3 = properties.getProperty("url3");
		   PropertyStore.URL4 = properties.getProperty("url4");
